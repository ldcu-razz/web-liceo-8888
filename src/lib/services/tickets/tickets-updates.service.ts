...
import type {
	GetTicketsUpdates,
	GetTicketsUpdatesPaginated,
	PostTicketsUpdates
} from '$lib/models/tickets/tickets-updates.type';
...
export const getTicketsUpdates = async (
	...
	ticketId?: string
): Promise<GetTicketsUpdatesPaginated> => {
...
export const getDepartmentAssignRemarkMessage = async (
	departmentId: string,
	assignedById: string
): Promise<string> => {
...
export const getUserAssignRemarkMessage = async (
	userId: string,
	assignedById: string
): Promise<string> => {
...
export const getPriorityChangeRemarkMessage = async (
...
export const getStatusChangeRemarkMessage = async (
