...
import {
	getCreateTicketRemarkMessage,
	getCreateTicketTitle,
	getDepartmentAssignRemarkMessage,
	getDepartmentAssignTitle,
	getPriorityChangeRemarkMessage,
	getPriorityChangeTitle,
	getStatusChangeRemarkMessage,
	getStatusChangeTitle,
	getTicketsUpdates,
	getUserAssignRemarkMessage,
	getUserAssignTitle,
	postTicketsUpdates
} from '$lib/services/tickets/tickets-updates.service';
...
export const ticketUpdatesActions = {
	...
	getCreateTicketPostBody: async (
		ticketId: string,
		assignedId: string
	): Promise<PostTicketsUpdates> => {
	...
	getDepartmentAssignPostBody: async (
		ticketId: string,
		departmentId: string
	): Promise<PostTicketsUpdates> => {
		const me = get(meStore);
	...
	getPriorityChangePostBody: async (
		ticketId: string,
		departmentId: string,
