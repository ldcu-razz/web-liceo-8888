...
import type {
	DeleteTicketCategoriesSchema,
	GetTicketCategoriesSchema,
	PostTicketCategoriesSchema,
	PutTicketCategoriesSchema,
	TicketCategoriesPaginatedSchema,
	TicketCategoriesSchema
} from './tickets-categories.schema';
