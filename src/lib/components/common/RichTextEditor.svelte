...
<div class="flex gap-2">
	...
	<div class="relative flex-1" {@attach attachEditorContainer}>
		...
		<div
			class={cn(
				'rich-comment-editor max-h-[300px] min-h-[120px] w-full overflow-y-auto rounded-b-md border border-gray-200 bg-white px-3 py-2 text-sm leading-6 break-all whitespace-pre-line outline-none focus-visible:border-gray-300',
				className
			)}
