<script lang="ts" module>
	...
	import type {
		GetNotifications,
		NotificationTicketCommentedMetadata
...
<script lang="ts">
	...
	let createdByUser = $derived(usersMap[notifMetadata.commented_by]);
		...
		<div class="center flex flex-1 gap-4">
			...
			<div class="flex flex-1 flex-col gap-1">
				<div class="flex items-center gap-2 text-sm">
					<span class="font-medium">{@html notification?.metadata?.title}</span>
				</div>
