...
<AlertDialog bind:open={showDeleteUserAlertDialog}>
	<AlertDialogContent>
		<AlertDialogHeader>
			<AlertDialogTitle
				>Are you sure to archive the user {activeUser?.firstname}
				{activeUser?.lastname}?</AlertDialogTitle
			>
			<AlertDialogDescription
				>Archiving this user will not be used in the system.</AlertDialogDescription
			>
		</AlertDialogHeader>
		<AlertDialogFooter>
