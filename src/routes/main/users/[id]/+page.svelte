<script lang="ts">
	...
	import {
		currentSelectedUser,
		currentSelectedUserLoading,
		usersActions
	} from '$lib/store/users.store';
		...
		<div class="mx-auto min-w-xl">
			<div class="flex flex-col gap-2">
				<div class="flex items-center justify-between">
					<div class="-mt-18 flex h-32 w-32 rounded-full border border-gray-200 bg-gray-50 p-1">
						...
						<Sheet bind:open={isEditUserInfoSheetOpen}>
							...
							<SheetContent class="min-w-3xl">
								...
								<UserForm
									...
									bind:formData
									formBordered={false}
									onCancel={handleCancelEditUserInfo}
...
<AlertDialog bind:open={showArchiveUserAlertDialog}>
	<AlertDialogContent>
		<AlertDialogHeader>
			...
			<AlertDialogDescription
				>Archiving this user will remove all related data.</AlertDialogDescription
			>
		</AlertDialogHeader>
		<AlertDialogFooter>
