...
<script lang="ts">
	...
	let createdByUserInitial = $derived(
		createdByUser
			? createdByUser?.firstname.slice(0, 1).toUpperCase() +
					createdByUser?.lastname.slice(0, 1).toUpperCase()
			: 'AU'
	);
...
<div class="flex flex-col gap-1 py-3">
	...
	{:else}
		<p class="ml-11 text-sm leading-relaxed break-word whitespace-pre-line text-gray-700">
