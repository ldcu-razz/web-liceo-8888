<script lang="ts" module>
  ...
  import { Table, TableBody, TableCell, TableHead, TableHeader, TableRow } from "$lib/components/ui/table";
	...
	import { departmentsActions, departmentsPagination, departmentsTotalCount } from "$lib/store/departments.store";
...
<script lang="ts">
  ...
  let totalCount = $derived($departmentsTotalCount);
 ...
 function handlePageChange(page: number) {
  departmentsActions.getDepartments({ page: page, size: pagination.size });
