...
<form class="rounded-md border border-border p-6">
	<FieldGroup class="flex flex-col gap-4">
		...
		<Field>
			...
			>
				...
				<SelectContent>
					<SelectItem value={SexEnumSchema.enum.male}
						>{transformText(SexEnumSchema.enum.male)}</SelectItem
					>
					<SelectItem value={SexEnumSchema.enum.female}
						>{transformText(SexEnumSchema.enum.female)}</SelectItem
					>
				</SelectContent>
			</Select>
